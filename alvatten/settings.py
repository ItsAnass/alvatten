...
SECRET_KEY = 'django-insecure-*8--%%%&h=pm98%^k0chmyuli7%i%z@ln_p-d*2@=8t=+%+&$8'
...
WSGI_APPLICATION = 'alvatten.wsgi.application'
...
## Removed duplicate/conflicting static/media settings
